Feature: Helpdesk approve partnership
    ...
    @v2-ci-pending @directpartnership @iostest
    Scenario: Helpdesk approve direct partnership
        ...
        Then the element ".govuk-error-summary" contains the text "You must confirm you are authorised to approve this partnership."
        ...
        And I click on the button "#edit-next"
        Then the element ".govuk-error-summary" contains the text "You must choose at least one regulatory function."
