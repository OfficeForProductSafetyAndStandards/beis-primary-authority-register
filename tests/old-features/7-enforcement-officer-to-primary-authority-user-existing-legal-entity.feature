...
#        # CHOOSE MEMBER
        ...
        When I add "Weatherby" to the inputfield "#edit-last-name"
        When I add "colin.weatherby@gmail.com" to the inputfield "#edit-work-phone"
        And I click on the button "#edit-next"
      ...
      # ENFORCEMENT SUMMARY
        ...
        And I click on the button "#edit-next"
        And I add "Enforcement notice one" to the inputfield "#edit-title"
        And I click on the radio ".form-radio"
        ...
        And the element "#par-enforcement-notice-raise-confirm" contains the text "Enforcement notice one"
...
#       Then the element ".table-scroll-wrapper" contains the text "Enforcement notice one"
