...
#        # CHOOSE MEMBER
      ...
      # ENFORCEMENT SUMMARY
        ...
        And I expect that element "#par-enforcement-notice-raise-confirm" contains the text "Enforcement notice One"
...
#       Then I expect that element ".table-scroll-wrapper" contains the text "Enforcement notice One"
