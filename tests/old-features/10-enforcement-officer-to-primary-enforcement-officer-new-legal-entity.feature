...
#        And I add "action summary enforcement notice" to the inputfield "#edit-summary"
       ...
       And I add "Enforcement notice two" to the inputfield "#edit-title"
...
#        And I click on the button "#edit-next"
       ...
       Then I expect that element "h1.heading-xlarge" contains the text "Legal Entity 1"
       Then I expect that element "#par-enforcement-notice-raise-confirm" contains the text "Enforcement notice two"
...
#        And I open the url "/user/logout"
        ...
        Then I expect that element ".table-scroll-wrapper" contains the text "Enforcement notice two"
