...
Feature: Enforcement Officer/Coordinator - Enforcement Notice Process
    ...
    Scenario: Enforcement Officer/Coordinator - Issue enforcement notice
        ...
        And I click on the button "#edit-next"
        And I add "Enforcement notice Three" to the inputfield "#edit-title"
        ...
        And I expect that element "#par-enforcement-notice-raise-confirm" contains the text "Enforcement notice Three"
