...
Feature: Coordinator User - Upload Members
    ...
    Scenario: Coordinator User - Upload Members
        ...
        When I click the link text "Organisation For Coordinated Partnership One"
        ...
        When I add "Organisation For Coordinated Partnership One" to the inputfield "#edit-keywords"
        ...
        And the element "#par-rd-help-desk-confirm" contains the text "Organisation For Coordinated Partnership One"
        ...
        And the element "#edit-partnership-info" contains the text "Organisation For Coordinated Partnership One"
