...
Feature: Enforcement notice management
    ...
    Scenario: Enforcement notice management
        ...
        And I click the link text "Title of enforcement notice 4"
        ...
        And I click the link text "See enforcement notifications sent"
        Then the element ".cols-6" contains the text "Title of enforcement notice 4"

        # BLOCK FORM

        And I click the link text "Title of enforcement notice 3"
...
#        Then the element ".heading-xlarge" contains the text "Confirm Enforcement Notice"
        ...
        And I click the link text "Dashboard"
        And I click the link text "See enforcement notifications sent"
        Then the element ".cols-6" contains the text "Title of enforcement notice 3"
        ...
        And I click the link text "Title of enforcement notice 1"
