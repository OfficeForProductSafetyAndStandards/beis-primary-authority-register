...
#        # CHOOSE MEMBER
      ...
      # ENFORCEMENT SUMMARY
        ...
        And the element "#par-enforcement-notice-raise-confirm" contains the text "Enforcement notice 1"
...
#       Then the element ".table-scroll-wrapper" contains the text "Enforcement notice 1"
