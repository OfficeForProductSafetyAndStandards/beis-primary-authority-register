...
#        And I add "action summary enforcement notice" to the inputfield "#edit-summary"
       ...
       And I add "Title of enforcement notice 4" to the inputfield "#edit-title"
       And I click on the radio ".form-radio"
...
#        And I click on the button "#edit-next"
       ...
       Then the element "h1.heading-xlarge" contains the text "Legal Entity 1"
       Then the element "#par-enforcement-notice-raise-confirm" contains the text "Title of enforcement notice 4"
...
#        And I open the path "/user/logout"
        ...
        Then the element ".table-scroll-wrapper" contains the text "Title of enforcement notice 4"
