...
Feature: Coordinator User - Upload Members
    ...
    Scenario: Coordinator User - Upload Members
        ...
        When I click the link text "Organisation For Coordinated Partnership 8"
        ...
        When I add "Organisation For Coordinated Partnership 8" to the inputfield "#edit-keywords"
        ...
        And the element "#par-rd-help-desk-confirm" contains the text "Organisation For Coordinated Partnership 8"
        ...
        And the element "#edit-partnership-info" contains the text "Organisation For Coordinated Partnership 8"
    ...
    Scenario: Test search criteria
        ...
        And I click on the button "#edit-submit-partnership-search"
        Then the element ".table-scroll-wrapper" contains the text "Organisation For Coordinated Partnership 8"
