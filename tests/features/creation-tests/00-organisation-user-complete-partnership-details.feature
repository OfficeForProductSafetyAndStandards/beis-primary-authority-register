Feature: Business User - Complete organisation details
    ...
    Scenario: Business User - Complete organisation details
        ...
        And I go to partnership detail page for my partnership "Organisation For Updating Direct Partnership" with status "confirmed_authority"
        ...
        And I submit final confirmation of completion by organisation "Organisation For Updating Direct Partnership"
