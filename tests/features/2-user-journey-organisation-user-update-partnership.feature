...
Feature: Business User - Manage Addresses
    ...
    Scenario: Business User - Manage Addresses
        ...
        And I click the link text "Organisation For Direct Partnership 8"
        ...
        And I click on the button "#edit-submit-par-user-partnerships"
        And the element "#block-par-theme-content" contains the text "Organisation For Direct Partnership 8"
