...
Feature: Enforcement Officer/Coordinator - Enforcement Notice Process
    ...
    Scenario: Enforcement Officer/Coordinator - Issue enforcement notice
        ...
        And I click on the button "#edit-next"
        And I add "Title of enforcement notice 3" to the inputfield "#edit-title"
        And I click on the radio ".form-radio"
        ...
        And the element "#par-enforcement-notice-raise-confirm" contains the text "Title of enforcement notice 3"
