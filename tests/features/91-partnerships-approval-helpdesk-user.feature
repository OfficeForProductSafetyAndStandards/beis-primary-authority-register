Feature: Helpdesk approve partnership
    ...
    Scenario: Helpdesk approve partnership
        ...
        # When I open the path "/helpdesk"
        # When I add "Organisation For Direct Partnership Revocation" to the inputfield "#edit-keywords"
    ...
    #     And I click on the button "#edit-submit-helpdesk-dashboard"
    #     Then the element ".table-scroll-wrapper" contains the text "Organisation For Direct Partnership Revocation"
    ...
    #     Then the element ".views-element-container" does not contain the text "Organisation For Direct Partnership Revocation"
