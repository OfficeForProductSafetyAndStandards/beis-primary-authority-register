...
module.exports = {
    ...
    commands: [{
        ...
        checkEmails: function (string, string2) {
            var emailSubject = ''
            switch (string) {
                case 'enforcement creation':
                    emailSubject = 'Primary Authority: Notification of Proposed Enforcement';
                    break;
                case 'partnership approval':
                    emailSubject = 'Primary Authority: Partnerships Nominated';
                    break;
                case 'partnership revocation':
                    emailSubject = 'Primary Authority: Notification of Partnership Revocation';
                    break;
                case 'partnership completed':
                    emailSubject = 'Primary Authority: Partnership Application Completed';
                    break;
                case 'partnership invitation':
                    emailSubject = 'Primary Authority: Invitation to join the Primary Authority Register';
                    break;
            }
        ...
        fillinContactDetails: function () {
            return client
                ...
                // browser.assert.title('Create a new Person | Add contact
                // details | Primary Authority Register')
                .useCss()
