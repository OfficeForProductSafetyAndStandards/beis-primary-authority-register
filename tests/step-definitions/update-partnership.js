...
When('I update about the organisation', function () {
  return shared
    ...
    .assert.containsText('h1 .heading-secondary', 'Primary Authority partnership information')
    .assert.containsText('h1', 'Information about the organisation')
...
When('I add and subsequently edit a trading name', function () {
    return shared
      ...
      .assert.containsText('h1', 'Add a trading name for your organisation')
      ...
      .clearValue('#edit-trading-name')
      .assert.containsText('h1', 'Edit trading name for your organisation')
  ...
  When('I edit the main authority contact', function () {
    return shared
      ...
      .click('#edit-next')
      .assert.containsText('h1', 'Review contact information')
...
When('I upload a file to the partnership advice section', function () {
  return shared
    ...
    .assert.containsText('h1', 'Uploading advice documents declaration')
...
return shared
      ...
      .click('#edit-next')
      .assert.containsText('h1', 'Invite the person to create an account')
...
return shared
      ...
      .assert.containsText('h1', 'Confirm removal of contact')
      .click('#edit-save')
  });
