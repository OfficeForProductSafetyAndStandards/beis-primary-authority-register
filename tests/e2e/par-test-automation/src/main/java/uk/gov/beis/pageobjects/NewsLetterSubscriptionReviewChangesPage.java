...
public class NewsLetterSubscriptionReviewChangesPage extends BasePageObject {
	public NewsLetterSubscriptionReviewChangesPage() throws ClassNotFoundException, IOException {
		super();
	}
