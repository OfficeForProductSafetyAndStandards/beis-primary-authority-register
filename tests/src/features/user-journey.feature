...
Scenario: User Journey Flow    
    ...
    And I add "Big Bird9" to the inputfield "#edit-person-name"
    And I add "91723456789" to the inputfield "#edit-work-phone"
    And I add "9777777777" to the inputfield "#edit-mobile-phone"
    And I add "par_authority9@example.com" to the inputfield "#edit-email"
    When I click on the button "#edit-next"
    Then the element "#edit-authority-contacts" contains the text "Big Bird9"
    And the element "#edit-authority-contacts" contains the text "par_authority9@example.com"
    ...
    When I click on the link "html.js body.js-enabled main#content div div#block-par-theme-content form#par-flow-transition-partnership-details-overview.par-flow-transition-partnership-details-overview div fieldset#edit-authority-contacts.js-form-item.form-item.js-form-wrapper.form-wrapper.inline div fieldset#edit-alternative-people.js-form-item.form-item.js-form-wrapper.form-wrapper.inline em.placeholder a.flow-link"
    And I add "Snuffleupagus9" to the inputfield "#edit-person-name"
    And I add "91723456789" to the inputfield "#edit-work-phone"
    And I add "9777777777" to the inputfield "#edit-mobile-phone"
    And I add "par_business9@example.com" to the inputfield "#edit-email"
    And I click on the button "#edit-next"
    Then the element "#edit-organisation-contacts" contains the text "Snuffleupagus9"
    And the element "#edit-organisation-contacts" contains the text "par_business9@example.com"
    ...
    And I add "917234567899" to the inputfield "#edit-work-phone" 
    And I add "97777777779" to the inputfield "#edit-mobile-phone"
    And I add "Elmo9" to the inputfield "#edit-person-name"
    And I add "par_business9@example.com" to the inputfield "#edit-email"
    When I click on the button "#edit-next"
    Then the element "#edit-alternative-people" contains the text "par_business9@example.com"
    And the element "#edit-alternative-people" contains the text "Elmo9"
    And the element "#edit-alternative-people" contains the text "917234567899"
    And the element "#edit-alternative-people" contains the text "97777777779"
