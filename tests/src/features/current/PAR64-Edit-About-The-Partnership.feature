...
Feature: As a Primary Authority Officer
    ...
    Scenario: Create New Partnership
        ...
        And I press "Edit Partnership Information"
        Then I expect that element "#partnership-information" contains the text "Edit the information about the partnership"
