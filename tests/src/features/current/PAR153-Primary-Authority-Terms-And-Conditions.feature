...
So that I can see the Primary Authority Terms and Conditions
    ...
    Background:
        ...
        And I expect that element "#logged-out-footer" contains the text "Primary Authority Terms and Conditions"

    Scenario Outline: Valid Login  Id
        And I add "<user id>" to the inputfield "#username"
        And I add "password" to the inputfield "#password"
        And I press "Login"
        And I expect that element "#logged-in-footer" contains the text "Primary Authority Terms and Conditions"
