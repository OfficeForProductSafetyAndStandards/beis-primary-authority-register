...
Feature: Organisation User - Complete business details
    ...
    Scenario: Organisation User - Complete business details
        ...
        Then I expect that element "#edit-legal-entities" does not contains the text "Third New LLP Company"
        Then I expect that element "#edit-legal-entities" contains the text "0000000000"
