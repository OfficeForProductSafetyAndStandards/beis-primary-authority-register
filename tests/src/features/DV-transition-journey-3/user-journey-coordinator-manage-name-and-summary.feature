...
Feature: Coordinator User - Manage Addresses
    ...
    Scenario: Manage business name and summary
        ...
        Then the element "#par-flow-transition-coordinator-details" contains the text "About the association"
        And the element "#par-flow-transition-coordinator-details" contains the text "Registered address"
        ...
        And I click on the button "#edit-next"
        Then the element "#par-flow-transition-coordinator-details" contains the text "Trading Name Change"
        When I click on the link "add another trading name"
        And I add "Trading Name Add" to the inputfield "#edit-trading-name"
        And I click on the button "#edit-next"
        Then the element "#par-flow-transition-coordinator-details" contains the text "Trading Name Add"
