Feature: Helpdesk approve partnership
    ...
    Scenario: Helpdesk approve partnership
        ...
        And I expect that element "#par-rd-help-desk-confirm" contains the text "Organisation For Direct Partnership"
        ...
        And I expect that element "#edit-partnership-info" contains the text "Organisation For Direct Partnership"
