Feature: Helpdesk approve partnership
    ...
    Scenario: Helpdesk approve partnership
        ...
        When I add "Business For Direct Partnership 21" to the inputfield "#edit-keywords"
        ...
        And I expect that element "#par-rd-help-desk-confirm" contains the text "Business For Direct Partnership 21"
        ...
        And I expect that element "#edit-partnership-info" contains the text "Business For Direct Partnership 21"
