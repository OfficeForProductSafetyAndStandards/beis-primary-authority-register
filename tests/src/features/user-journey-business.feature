...
Background:
    ...
    Scenario: Manage business name and summary
        ...
        And I click on the link "#edit-registered-address em.placeholder a.flow-link"
        ...
        And I click on the link "##edit-primary-contact > em.placeholder > a.flow-link"	
        ...
        And I click on the button "#edit-next"	
        Then the element "#edit-primary-contact > div" contains the text "Fozzie Bear"	
        ...
        And I click on the link "##edit-alternative-people > em.placeholder > a.flow-link"	
        ...
        And I click on the button "#edit-next"	
        Then the element "#edit-primary-contact > div" contains the text "Fozzie Bear"	
        Then the element "#edit-primary-contact" contains the text "par_authority_change@example.com"	
        Then the element "#edit-primary-contact" contains the text "2079999999"	
        Then the element "#edit-primary-contact" contains the text "78659999999"	
        And I click on the link "##edit-legal-entity > em.placeholder > a.flow-link"
