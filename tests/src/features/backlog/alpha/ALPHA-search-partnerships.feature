...
Feature: Searching partnerships
    ...
    Scenario: Search By Business
        ...
        Then the element "#search-businesses" contains the text "Search for a Partnership by Business"
        When I click on the radio "#by-name"
        Then the element "#business_name" does exist
        And I add "Joe" to the inputfield "#business_name"
        And I press "Continue"
        Then the element "#search-results" does exist
        When I click on the radio "#first-search-result-radio"
        And I press "Continue"
        Then the element "#logged-in-header" contains the text "Primary Authority Partnerships"
        When I click on the link "#show-details"
        Then the element "#about-the-business" does exist

    Scenario: Search By Coordinator
        Given I open the url "/search-partnerships"
        And I click on the radio "#by-coordinator"
        And I press "Continue"
        Then the element "#search-businesses" contains the text "Search for a Partnership by Coordinator"
        When I click on the radio "#by-coordinator"
        And I press "Continue"
        Then the element "#search-results" does exist
        When I click on the radio "#first-search-result-radio"
        And I press "Continue"
        Then the element "#header" contains the text "Primary Authority Partnerships"
        When I click on the link "#show-details"
        Then the element "#about-the-business" does exist
    ...
    Scenario: Search By Primary Authority
        ...
        And I press "Continue"
        Then the element "#search-businesses" contains the text "Search for a Partnership by Primary Authority"
