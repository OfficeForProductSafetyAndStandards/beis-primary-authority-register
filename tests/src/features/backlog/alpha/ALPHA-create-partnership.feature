...
Feature: Create Partnerships
    ...
    Scenario: Create New Partnership
        ...
        Then the element "#header" contains the text "New Partnership Application"
        ...
        Then the element "#header" contains the text "Partnership contact details"
        When I click on the link "#main-primary-authority-contact"
        And I press "Continue"
        Then the element "#primary-authority-contact-heading" is visible
        Then the element "#primary-authority-contact-email" is visible
        ...
        When I press "Continue"
        Then the element "#business-name-heading" is visible
        When I add "Test Company 1" to the inputfield "#business-name"
        And I press "Continue"
        Then the element "#existing-partnerships-check-heading" is visible
        When I click on the radio "#new-partnership"
        And I press "Continue"
        Then the element "#business-address-details-heading" is visible
        ...
        Then the element "#buisness-address-details" is visible
        And I press "Continue"
        Then the element "#business-main-contact-details" is visible
        ...
        When I press "Continue"
        Then the element "#environmental-health-contact" is visible
        When I click on the radio "#environmental-health-contact-1"
        And I press "Continue"
        Then the element "#trading-standards-contact" is visible
        When I click on the radio "#trading-standards-contact-1"
        And I press "Continue"
        Then the element "#licencing-contact" is visible
        When I click on the radio "#licencing-contact-1"
        And I press "Continue"
        Then the element "#partnership-information" is visible
        When I add "some extra information about partnership" to the inputfield "#partnership-information"
        And I press "Continue"
        Then the element "#partnership-information-review" is visible
        When I click on the checkbox "#partnership-information-confirm"
        And I press "Continue"
        Then the element "#partnership-complete-notification" is visible
        When I click on the radio "#send-to-business-for-completion"
        And I press "Continue"
        Then the element "#business-contact-mail-sent-success" is visible
