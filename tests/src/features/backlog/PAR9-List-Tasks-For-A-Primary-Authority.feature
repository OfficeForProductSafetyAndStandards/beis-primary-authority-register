...
#        And I press "Continue"
#        Then the element "#review-and-confirm-partnership-details" contains the text "Review and confirm your partnership information"
#        And the element "#areas-of-regulatory-advice" does exist
#
#        When I click on the link "#about-edit"
#        Then the element "#partnership-information-edit-title" does exist
#        When I click on the link "#cancel-edit"
#
#        And I click on the link "#main-primary-authority-contact-edit"
#        Then the element "#main-primary-authority-contact-edit-title" does exist
#        When I click on the link "#cancel-edit"
#
#        And I click on the link "#second-primary-authority-contact-edit"
#        Then the element "#second-primary-authority-contact-edit-title" does exist
#        When I click on the link "#cancel-edit"
#
#
...
#        And I press "Confirm"
#
#        Then the element "#success-header" contains the text "You have successfully confirmed all your Primary Authority information for your partnership"
#        And I press "Done"
