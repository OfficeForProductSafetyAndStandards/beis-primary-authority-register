...
Feature: PAR User - Change Partnership Details
    ...
    Scenario: User Journey 1 - Change partnership details
        ...
        When I click on the button "form#par-flow-transition-partnership-details-overview .organisation-alternative-contacts-0 a.flow-link"
        And I add "917234567899" to the inputfield "#edit-work-phone"
        And I add "97777777779" to the inputfield "#edit-mobile-phone"
        ...
        When I click on the button "#edit-next"
        Then the element ".organisation-alternative-contacts-0" contains the text "par_business_pepe@example.com"
        And the element ".organisation-alternative-contacts-0" contains the text "Pepe"
        And the element ".organisation-alternative-contacts-0" contains the text "the King Prawn"
        And the element ".organisation-alternative-contacts-0" contains the text "917234567899"
        And the element ".organisation-alternative-contacts-0" contains the text "97777777779"
