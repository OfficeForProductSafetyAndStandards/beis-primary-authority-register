...
Feature: PAR User - Change Partnership Details
    ...
    Scenario: User Journey 1 - Change partnership details
        ...
        When I click on the button "form#par-flow-transition-partnership-details-overview .alternative-person a.flow-link"
...
#        When I click on the button "form#par-flow-transition-partnership-details-overview #edit-authority-contacts #edit-authority-alternative-contacts a.flow-link"
...
#        And the element "#edit-authority-alternative-contacts" contains the text "97777777779"
        ...
        When I click on the button "form#par-flow-transition-partnership-details-overview #edit-organisation-alternative-contacts a.flow-link"
        And I add "917234567899" to the inputfield "#edit-work-phone"
        And I add "97777777779" to the inputfield "#edit-mobile-phone"
        ...
        When I click on the button "#edit-next"
        Then the element "#edit-organisation-alternative-contacts" contains the text "par_business_pepe@example.com"
        And the element "#edit-organisation-alternative-contacts" contains the text "Pepe"
        And the element "#edit-organisation-alternative-contacts" contains the text "the King Prawn"
        And the element "#edit-organisation-alternative-contacts" contains the text "917234567899"
