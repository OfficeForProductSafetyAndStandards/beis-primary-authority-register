...
class ParAddressForm extends ParBaseForm {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $premises = $par_data_premises ?: ParDataPremises::create([
      'type' => 'premises',
    ...
    if ($premises) {
      ...
      if ($par_data_organisation && $premises->save()) {
        // Add premises to organisation if a new PAR Premises record is new.
        if ($premises) {
