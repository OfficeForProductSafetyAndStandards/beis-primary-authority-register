...
class ParTradingForm extends ParBaseForm {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $item = $this->getFlowDataHandler()->getTempDataValue('trading_name');

    // Use index in URI to modify specific trading name field value.
    if ($trading_name_delta) {
      // @todo - decide what to do in this scenario when using indexes.
    }
    else {
      $par_data_organisation->get('trading_name')->appendItem($item);
    }
