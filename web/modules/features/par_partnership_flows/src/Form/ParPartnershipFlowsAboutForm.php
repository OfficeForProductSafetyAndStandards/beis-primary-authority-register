...
class ParPartnershipFlowsAboutForm extends ParBaseForm {
  ...
  public function retrieveEditableValues(ParDataPartnership $par_data_partnership = NULL) {
    if ($par_data_partnership) {
      ...
      // don't output HTML tags on edit forms.
      $this->getFlowDataHandler()->setFormPermValue('about_partnership', $this->cleanseParOutput($par_data_partnership->about_partnership->value));
    }
  }
