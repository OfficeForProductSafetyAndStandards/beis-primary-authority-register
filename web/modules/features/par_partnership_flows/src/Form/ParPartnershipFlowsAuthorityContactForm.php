 ...
 */
class ParPartnershipFlowsAuthorityContactForm extends ParPartnershipFlowsContactForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, ParDataPartnership $par_data_partnership = NULL, ParDataPerson $par_data_person = NULL) {
    ...
    $form['leading_paragraph'] = [
      '#type' => 'markup',
      '#markup' => t('Change the main contact for the  organisation'),
      '#prefix' => '<p><strong>',
      '#suffix' => '</strong></p>'
    ];
