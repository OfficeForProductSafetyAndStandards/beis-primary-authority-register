...
//    ];
    ...
    $build['primary_person_2'] = $partnership_primary_person->getViewBuilder()->view('teaser');
...
//    ];
    ...
    // Table data/cells.
    $overview_link = $this->getFlow()->getLinkByStep(2)
      ->setText('Review and confirm your partnership details')
      ->toString();
    $rows = [
      [
        $overview_link,
        $this->arePartnershipDetailsConfirmed($par_data_partnership) ? 'Approved' : 'awaiting review',
      ]
    ];
