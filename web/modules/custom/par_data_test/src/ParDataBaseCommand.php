...
/**
 * @file
 * Contains \Drupal\par_data_test\ParDataBaseCommand.
 */
...
/**
 * Class ParDataCommand
 *
 * @package Drupal\Console\Command\Generate
 */
class ParDataBaseCommand extends Command
{
    use CreateTrait;
    ...
    {
        $this
            ->setName('create:par-data-partnership')
