...
class ParMemberListLink extends ParFormPluginBase {
  ...
  public function loadData($cardinality = 1) {
    ...
    if ($par_data_partnership instanceof ParDataEntityInterface && $par_data_partnership->isCoordinated()) {
      ...
      $this->setDefaultValuesByKey('member_link', $cardinality, $link ? $link->toString() : '');
    }
  ...
  public function getElements($form = [], $cardinality = 1) {
    ...
    $form['member_link'] = [
      ...
      '#default_value' => $this->getDefaultValuesByKey('member_link', $cardinality),
    ];
  ...
  public function validate($form, &$form_state, $cardinality = 1, $action = ParFormBuilder::PAR_ERROR_DISPLAY) {
    ...
    try {
      ...
      $id_key = $this->getElementKey('member_link', $cardinality, TRUE);
