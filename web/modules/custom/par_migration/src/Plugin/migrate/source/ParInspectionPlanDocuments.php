...
/**
 * Migration of PAR2 Inspection Plan documents.
 *
 * @MigrateSource(
 *   id = "par_migration_inspection_plan_documents"
 * )
 */
class ParInspectionPlanDocuments extends SqlBase {
  ...
  public function query() {
    return $this->select($this->table, 'b')
      ...
      ->condition('owning_object_type', 'Inspection Plan');
  }
