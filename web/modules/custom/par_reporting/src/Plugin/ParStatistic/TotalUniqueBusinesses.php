  ...
  public function getStat(): int {
    ...
    foreach ($partnerships as $partnership) {
      ...
      if ($partnership->isDirect()) {
        ...
        // Get a list of all legal entities covered by
        // this partnership keyed by a unique key.
      ...
      if ($partnership->isCoordinated()) {
        switch ($partnership->getMemberDisplay()) {
          ...
          // If the member list hasn't been updated since release `v63.0`
          // just count the partnership once.
          default:
            $count[] = $partnership->label();
        }
      }
