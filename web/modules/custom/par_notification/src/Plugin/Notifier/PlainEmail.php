...
namespace Drupal\par_notification\Plugin\Notifier;
 ...
 * @Notifier(
 *   id = "plain_email",
 *   title = @Translation("Plain text e-mail"),
 *   description = @Translation("Send plain text messages via email"),
 *   viewModes = {
 *     "mail_subject",
 *     "mail_body"
 *   }
 * )
 */
class PlainEmail extends MessageNotifierBase {
