...
class NewDeviationRequestSubscriber implements EventSubscriberInterface {
  ...
  public function onNewDeviationRequest(EntityEvent $event) {
    ...
    if ($primary_authority_contact && ($account = $primary_authority_contact->lookupUserAccount()) && $primary_authority_contact->lookupUserAccount()->hasPermission('approve enforcement notice')
