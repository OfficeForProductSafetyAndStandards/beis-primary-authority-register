...
class NewGeneralEnquirySubscriber implements EventSubscriberInterface {
  ...
  public function onNewGeneralEnquiry(EntityEvent $event) {
    ...
    if ($primary_authority_contact && ($account = $primary_authority_contact->getUserAccount()) && $primary_authority_contact->getUserAccount()->hasPermission('view general enquiry')
