...
class NewInspectionFeedbackSubscriber implements EventSubscriberInterface {
  ...
  public function onNewInspectionFeedback(EntityEvent $event) {
    ...
    if ($primary_authority_contact && ($account = $primary_authority_contact->getUserAccount()) && $primary_authority_contact->getUserAccount()->hasPermission('view inspection feedback')
