 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/par_data/par_data_inspection_feedback_type/{par_data_inspection_feedback_t}",
 *     "edit-form" = "/admin/structure/par_data/par_data_inspection_feedback_type/{par_data_inspection_feedback_t}/edit",
 *     "delete-form" = "/admin/structure/par_data/par_data_inspection_feedback_type/{par_data_inspection_feedback_t}/delete",
