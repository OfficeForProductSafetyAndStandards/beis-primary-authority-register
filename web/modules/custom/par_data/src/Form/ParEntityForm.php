...
class ParEntityForm extends TranceForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if (isset($form['revision_information'])) {
      $form['revision_information']['#access'] = $entity->isNewRevision() || $account->hasPermission('administer par entities');
    }

    if (isset($form['revision'])) {
      $form['revision']['#access'] = $account->hasPermission('administer par entities');
    }
