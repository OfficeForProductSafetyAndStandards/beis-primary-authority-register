...
# Install dependencies
    ...
    docker exec -ti par_beta_web bash -c 'chmod -R 777 vendor && rm -rf vendor/* && su - composer -c "cd ../../var/www/html && php composer.phar install"'
...
# Load the test data:
    ...
    docker exec -it par_beta_web bash -c "vendor/bin/drush sql-cli @dev --root=/var/www/html/web < docker/fresh_drupal_postgres.sql"
...
# Install front end dependencies
    ...
    docker exec -it par_beta_web bash -c "rm -rf node_modules/* && ../../../usr/local/n/versions/node/7.2.1/bin/npm install"
