...
docker exec -ti par_beta_web bash -c 'su - composer -c "cd /var/www/html && php composer.phar install"'
...
# Install front end dependencies
    ...
    docker exec -i par_beta_web /usr/local/n/versions/node/7.2.1/bin/npm run gulp
