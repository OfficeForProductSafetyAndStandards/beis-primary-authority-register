...
parser.add_argument("-f", dest="sqlfile", help="The full path to the SQL file to import", default="/home/vcap/app/web/devops/docker/fresh_drupal_postgres.sql")
...
os.system("cd /home/vcap/app/devops/scripts && sh drop.sh /home/vcap/app")
os.system("/home/vcap/app/bin/pgsql/bin/psql -h " + host + " " + name + " " + username + " < " + results.sqlfile)
os.system("cd /home/vcap/app/devops/scripts && sh drupal-update.sh /home/vcap/app")
