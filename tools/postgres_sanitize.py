...
e = json.loads(os.environ.get('APP_ENV'))
...
if e !== 'production':
  ...
  os.system("cd /home/vcap/app/devops/scripts && sh drupal-dump.sh /home/vcap/app paas drush-dump-" + os.environ["APP_ENV"] + "-sanitized-latest.sql")
